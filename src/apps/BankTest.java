...
public class BankTest {
    ...
    public void accountCanMakeTransfer()throws Exception{
        ...
        bank.Withdraw(new BigDecimal("1000"), "3456456789", "2345");
        assertEquals(new BigDecimal("1000"), bank.checkBalance("456456789", "2345"));
        bank.deposit(new BigDecimal("2000"), "3456456789");
        assertEquals(new BigDecimal("3000"), bank.checkBalance("3456456789", "2345"));
        bank.transfer(new BigDecimal("2000"),  "3456456789", "1234567891", "2345");
        assertEquals(new BigDecimal("1000"),  bank.checkBalance("3456456789", "2345"));
    }
